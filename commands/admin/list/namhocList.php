...
class namhocList{
    ...
    function saveFormData(){
        ...
        if($data['default']['id'] > 0){
            ...
            $data['default']['code'] = Utility::processedCheckField('c_namhoc', 'code', $data['default']['name'], true);
        }
        ...
        if($name_exist == 1){
            ...
            $result = Utility::processedSaveData('c_namhoc', $data['default'], $skip, $json);
            if($result['status'] == "OK"){
                $response['status'] = 'OK';
    ...
    function deleteFormData(){
        ...
        $result = Utility::processedDeleteData('c_namhoc', $data);
        if($result['status'] == "OK"){
            $response['status'] = 'OK';
        } 
        return $response;
