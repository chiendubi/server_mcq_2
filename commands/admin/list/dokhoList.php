...
class dokhoList{
    ...
    function saveFormData(){
        ...
        if($data['default']['id'] > 0){
            ...
            $data['default']['code'] = Utility::processedCheckField('c_dokho', 'code', $data['default']['name'], true);
        }
        ...
        if($name_exist == 1){
            ...
            $result = Utility::processedSaveData('c_dokho', $data['default'], $skip, $json);
            if($result['status'] == "OK"){
                $response['status'] = 'OK';
    ...
    function deleteFormData(){
        ...
        $result = Utility::processedDeleteData('c_dokho', $data);
        if($result['status'] == "OK"){
            $response['status'] = 'OK';
        } 
        return $response;
